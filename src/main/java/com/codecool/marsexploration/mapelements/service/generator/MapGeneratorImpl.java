...
public class MapGeneratorImpl implements MapGenerator {
    ...
    public MapModel generate(MapConfiguration mapConfig) {
        int mapDimension = (int) Math.ceil((Math.sqrt(mapConfig.mapSize())));
        String[][] mapToFill = createEmptyMapRepresentation(mapDimension, mapDimension);
        ...
        return new MapModel(mapToFill);
    }

    public String[][] createEmptyMapRepresentation(int rows, int columns) {
